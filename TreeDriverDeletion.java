/** Same as TreeDriver class but allows for exclusive paths by outright removing nodes that have an option
 * that is exclusive with an already selected option
 * 
...
public class TreeDriverDeletion{
            ...
            if(line.equals("H")){
                if(tree == null){
                    ...
                    while(temp != null){
                        ...
                        if(!response.trim().equals("B") && answer < numChildren && answer >= 0
                            ...
                            for(String siblingLabel : list){
                                ...
                                tree.remove(sibling, tree.getRoot());
